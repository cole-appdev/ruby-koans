...
class AboutRegularExpressions < Neo::Koan
  def test_a_pattern_is_a_regular_expression
    assert_equal /Az/.class, /pattern/.class
  end
  ...
  # From RubyDocs:
        ...
        # By contrast, lazy matching makes the minimal amount of matches necessary for overall success. A greedy 
        # metacharacter can be made lazy by following it with ?.
        # Extra:
        # A quantifier followed by + matches possessively: once it has matched it does not backtrack. They behave like greedy quantifiers, 
        # but having matched they refuse to “give up” their match even if this jeopardises the overall match. 
  # ------------------------------------------------------------------
