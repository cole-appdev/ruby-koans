...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # inject sets the initial value of the first variable (sum or product)
  ...
  # It is possible that the first strategy closes the file after the do block completes, so the file doesn't remain open.
